...
interface SalesManagerPageShellProps {
  badge: ReactNode
  title: string
  description: string
  actions?: ReactNode
...
export function SalesManagerPageShell({ badge, title, description, actions, children, className }: SalesManagerPageShellProps) {
  return (
